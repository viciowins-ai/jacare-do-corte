...
export function LoginPage() {
    ...
    return (
        <AuthLayout>
            ...
            {/* Main Content */}
            <div className="flex-1 flex flex-col items-center px-8 pt-10 bg-[#F5F5F7]">
                ...
                <p className="text-gray-500 text-sm text-center mb-8">
                    Faça login para agendar seu horário e acompanhar seus atendimentos.
                </p>
                ...
                <p className="text-gray-400 text-xs text-center mt-8 leading-relaxed px-2">
                    ...
                    <span className="text-[#2E5C38] font-medium">Termos de Uso</span> e{' '}
                    <span className="text-[#2E5C38] font-medium">Política de Privacidade</span>.
                </p>
            </div>
        </AuthLayout>
    );
