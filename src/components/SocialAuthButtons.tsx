...
export function SocialAuthButtons({ className, ...props }: ComponentProps<'div'>) {
    ...
    return (
        <div className={`flex justify-center gap-4 ${className}`} {...props}>
            {/* Google */}
            <button
                type="button"
                onClick={() => handleLogin('google')}
                className="w-14 h-14 rounded-full bg-white border border-gray-200 shadow-sm flex items-center justify-center hover:scale-105 active:scale-95 transition-all"
            ...
            <button
                ...
                className="w-14 h-14 rounded-full bg-[#1877F2] shadow-sm flex items-center justify-center hover:scale-105 active:scale-95 transition-all"
            ...
            <button
                ...
                className="w-14 h-14 rounded-full bg-gradient-to-tr from-[#FFDC80] via-[#FD1D1D] to-[#E1306C] shadow-sm flex items-center justify-center hover:scale-105 active:scale-95 transition-all"
